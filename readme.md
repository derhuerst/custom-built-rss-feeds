# list of custom-built [RSS](https://en.wikipedia.org/wiki/RSS) feeds
...
## tools for creating a feed

- [*fivefilters* Feed Creator](https://createfeed.fivefilters.org) – define scraping instructions, get a hosted RSS feed ✨
